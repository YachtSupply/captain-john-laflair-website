...
export const TEMPLATE_VERSION = '1.1.1';
...
export const siteConfig = {
  ...
  boatwork: {
    profileSlug: 'captain-john-laflair',
    profileId: 'e90c4286-2b1c-4ffe-82ce-99cec5d837db', // UUID — set during provisioning, permanent link to profile
